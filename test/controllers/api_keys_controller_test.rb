...
class ApiKeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_key" do
    assert_difference('ApiKey.count') do
      post api_keys_url, params: { api_key: { email: @api_key.email, key: @api_key.key, total_use: @api_key.total_use } }
    end
  ...
  test "should update api_key" do
    patch api_key_url(@api_key), params: { api_key: { email: @api_key.email, key: @api_key.key, total_use: @api_key.total_use } }
